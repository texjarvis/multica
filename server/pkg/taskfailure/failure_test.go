...
func TestReasonStringWireValues(t *testing.T) {
	...
	cases := []struct {
		...
		{ReasonProviderLivenessTimeout, "provider_liveness_timeout"},
		{ReasonIterationLimit, "iteration_limit"},
		{ReasonAgentBlocked, "agent_blocked"},
		{ReasonAPIInvalidRequest, "api_invalid_request"},
		{ReasonAdaptiveRoutingAdmissionFailed, "adaptive_routing_admission_failed"},
		// Agent-side.
...
func TestAllReasonsContents(t *testing.T) {
	...
	required := []Reason{
		...
		ReasonTimeout, ReasonProviderLivenessTimeout, ReasonIterationLimit,
		ReasonAgentBlocked, ReasonAPIInvalidRequest,
		ReasonAdaptiveRoutingAdmissionFailed,
